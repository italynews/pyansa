...
LINKS = {
    ...
    MONDO : BASE_URL + "sito/notizie/mondo/mondo_rss.xml",
    ECONOMIA : BASE_URL + "sito/notizie/economia/economia_rss.xml",
    CALCIO : BASE_URL + "sito/notizie/sport/calcio/calcio_rss.xml",
    SPORT : BASE_URL + "sito/notizie/sport/sport_rss.xml",
    CINEMA : BASE_URL + "sito/notizie/cultura/cinema/cinema_rss.xml",
    CULTURA : BASE_URL + "sito/notizie/cultura/cultura_rss.xml",
    TECNOLOGIA : BASE_URL + "sito/notizie/tecnologia/tecnologia_rss.xml",
    ULTIMAORA : BASE_URL + "sito/notizie/topnews/topnews_rss.xml",
